...
import { TagForm, TagFormRef, TagFormData } from "@/components/TagForm";
import {
  getTags,
  deleteTag,
  createTag,
...
export default function TagsPage() {
  ...
  const [sortBy, setSortBy] = React.useState<string | undefined>("title");
  ...
  const formRef = React.useRef<TagFormRef>(null);
  ...
  const handleDialogSubmit = async () => {
    ...
    try {
      ...
      if (dialogMode === "create") {
        ...
        await updateTag(editTarget._id, formData);
      }
      ...
      console.error(`Error ${dialogMode === "create" ? "creating" : "updating"} tag:`, err);
      setDialogError(
        err.response?.data?.message ||
          `Failed to ${dialogMode === "create" ? "create" : "update"} tag`
      );
    } finally {
