...
export default function AttributesPage() {
  ...
  const [editTarget, setEditTarget] = React.useState<Attribute | null>(null);
  const [dialogLoading, setDialogLoading] = React.useState(false);
  const [dialogError, setDialogError] = React.useState<string | null>(null);
  const formRef = React.useRef<AttributeFormRef>(null);
  ...
  const handleDialogSubmit = async () => {
    ...
    try {
      ...
      if (dialogMode === "create") {
        ...
        await updateAttribute(editTarget._id, formData);
      }
      ...
      setDialogError(
        err.response?.data?.message || "Failed to save attribute"
      );
    } finally {
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage clothing characteristics like Size, Color, and Material
        </p>
      </div>
      ...
      <DeleteConfirmDialog
        ...
        description='Are you sure you want to delete "{entityName}"? This will also delete all related attribute values and subcategory-attribute mappings. This action cannot be undone.'
      ...
      <EntityDialog
        ...
        title={dialogMode === "create" ? "Create Attribute" : "Edit Attribute"}
        description={
          dialogMode === "create"
            ? "Add a new attribute to the taxonomy"
